...
$(document).ready(function () {
  ...
  function callToaster(positionClass) {
    if (document.getElementById("toaster")) {
      ...
      toastr.success("Selamat Datang", `Hallo ${nama}!`);
    }
  }
  ...
  /*======== HOVERABLE DATA TABLE ========*/
  var hoverableDataTable2 = $("#hoverable-data-table2");
  if (hoverableDataTable2.length !== 0){
    hoverableDataTable2.DataTable({
      "aLengthMenu": [[20, 30, 50, 75, -1], [20, 30, 50, 75, "All"]],
      "pageLength": 20,
      "dom": '<"row justify-content-between top-information"lf>rt<"row justify-content-between bottom-information"ip><"clear">'
    });
  ...
  /*======== HOVERABLE DATA TABLE ========*/
  var hoverableDataTable3 = $("#hoverable-data-table3");
  if (hoverableDataTable3.length !== 0){
    hoverableDataTable3.DataTable({
      "aLengthMenu": [[20, 30, 50, 75, -1], [20, 30, 50, 75, "All"]],
      "pageLength": 20,
      "dom": '<"row justify-content-between top-information"lf>rt<"row justify-content-between bottom-information"ip><"clear">'
    });
